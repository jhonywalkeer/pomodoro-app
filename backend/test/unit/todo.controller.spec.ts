...
import { UpdateTodoDto } from '../../src/shared/dto/update-todo.dto';
...
const updateTodoEntity = new TodoEntity({
  task: 'taks-1',
  isDone: 1,
});
...
describe('TodoController', () => {
  ...
  describe('show', () => {
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(todoController.show('1')).rejects.toThrowError('Error');
    });
  });
  ...
  describe('update', () => {
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(todoController.update('1', body)).rejects.toThrowError('Error');
    });
  });
  ...
  describe('destroy', () => {
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(todoController.destroy('1')).rejects.toThrowError('Error');
    });
  });
});
